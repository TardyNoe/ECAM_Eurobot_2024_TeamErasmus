...
def image_callback(msg):
    ...
    circles = cv2.HoughCircles(dilated_mask, cv2.HOUGH_GRADIENT, dp=6, minDist=20, param1=100, param2=30, minRadius=10, maxRadius=70)
    ...
    if circles is not None:
        ...
        pose.header.frame_id = "parent_frame"  # Replace with your frame_id
